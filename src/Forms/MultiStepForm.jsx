...
{step === 7 && (
          ...
          {/* <button className='' type="button" onClick={createPatientProfile}>
            ...
            <button className='lg:block text-white bg-green-400 hover:bg-green-800 focus:ring-4 focus:outline-none focus:ring-green-300 font-medium rounded-lg text-sm px-4 text-center dark:bg-green-600 dark:hover:bg-green-700 dark:focus:ring-green-800' type="button" onClick={nextStep}>
              Submit
            </button>
            </div>
        </div>
