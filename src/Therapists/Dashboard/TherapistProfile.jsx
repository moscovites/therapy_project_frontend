...
const TherapistProfile = () => {
    ...
    let createTherapistProfile = async () => {
        console.log(formData)
        let response = await fetch("http://127.0.0.1:8000/onboarding/therapist", {
          method: 'POST',
          headers: {
  ...
  return (
   ...
   <div class="h-full px-3 py-4 overflow-y-auto bg-gray-50 dark:bg-gray-800">
      <ul class="space-y-2 font-medium mt-10">
         ...
         <li>
            <a href="/dashboard/therapist" class="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
...
<div class="flex items-center mx-auto w-1/2">
    <label for="dropzone-file" class="flex flex-col items-center justify-center w-full h-44 border-2 border-gray-300 border-dashed rounded-lg cursor-pointer bg-gray-50 dark:hover:bg-bray-800 dark:bg-gray-700 hover:bg-gray-100 dark:border-gray-600 dark:hover:border-gray-500 dark:hover:bg-gray-600">
        <div class="flex flex-col items-center justify-center pt-5 pb-6">
            ...
            <p class="mb-2 text-sm text-gray-500 dark:text-gray-400"><span class="font-semibold">Click to upload profile photo</span> or drag and drop</p>
  ...
  <button
  onClick={createTherapistProfile}
